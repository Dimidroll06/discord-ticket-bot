...
module.exports = {
    ...
    async execute(interaction, client){
        ...
        var ticketTypes = client.config.tickets.ticketTypes; // all ticket types
        var emmiter = client.ticketEmmiter; // custom emmiter
        // ticket type (If open ticket interaction)
        var ticketType = ticketTypes.find( v => v.codeName == interaction.customId );
