const { Client, Interaction, EmbedBuilder, ActionRowBuilder, ButtonBuilder, ButtonStyle, TextChannel } = require("discord.js");
...
module.exports = {
    ...
    async execute(interaction, client, channel, ticket){
        ...
        var ticketOpenedEmbed = new EmbedBuilder()
        ...
        var rolesToPing = Array.from(new Set([...client.config.tickets.rolesWhoHaveAccessToTheTickets, ...ticket.type.rolesHaveAccess]));
